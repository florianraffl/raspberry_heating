"""Switch platform for raspberry_heating."""
...
async def async_setup_entry(
    ...
    async_add_entities(
        IntegrationRaspberryHeatingSwitch(
...
class IntegrationRaspberryHeatingSwitch(
    IntegrationRaspberryHeatingEntity, SwitchEntity
):
    """raspberry_heating switch class."""
